import './App.css';
 import logo from './images/logo.png'; // Make sure to provide the correct path to your logo image
...
function App() {
  return (
    ...
    <div>
      <div>
        <nav className="navbar navbar-light mb-0" style={{ backgroundColor: "#22313f" }}>
          <div className="container-fluid">
            <img src={logo} alt='logo' height="20rem"/>
            <button className="btn text-white" type="submit" style={{ backgroundColor: "#a2c11c" }}>Buy Now</button>
          </div>
        </nav>
      </div>
        ...
        <nav className="navbar navbar-expand-lg navbar-light " style={{ marginBottom:"-2%"}}>
          <div className="container-fluid d-flex flex-column flex-lg-row justify-content-between">
            <div className="element mb-1 mb-lg-0">
              <img src={logo1} alt="logo1" height="18rem" className='mb-2'/>
            </div>
            <div className="element" id="navbarText">
            ...
            <div className="element">
              <div className='d-flex'>
                <div style={{marginRight:"0.5rem"}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
</svg></div>
                    <div style={{marginRight:"0.5rem"}}><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16">
          ...
          <div class="col-sm-7">
            <div class="card mb-4">
              <div class="card-body d-flex justify-content-between">
                  ...
                  <div className='mt-2'>
                    <button type="button" class="btn btn-light" style={{backgroundColor:"#d3d6db"}}>Change</button>
                  </div>
              </div>
            </div>
            <div class="card mb-4">
    ...
    <div class="card border-0">
      ...
      <div class="card-body">
        <div class="row border-bottom pb-3 mb-3">
          <div class="col-md-3 card d-flex align-items-center justify-content-center bg-light border-0">
  ...
  <path d="M6.192 2.78c-.458-.677-.927-1.248-1.35-1.643a2.972 2.972 0 0 0-.71-.515c-.217-.104-.56-.205-.882-.02-.367.213-.427.63-.43.896-.003.304.064.664.173 1.044.196.687.556 1.528 1.035 2.402L.752 8.22c-.277.277-.269.656-.218.918.055.283.187.593.36.903.348.627.92 1.361 1.626 2.068.707.707 1.441 1.278 2.068 1.626.31.173.62.305.903.36.262.05.64.059.918-.218l5.615-5.615c.118.257.092.512.05.939-.03.292-.068.665-.073 1.176v.123h.003a1 1 0 0 0 1.993 0H14v-.057a1.01 1.01 0 0 0-.004-.117c-.055-1.25-.7-2.738-1.86-3.494a4.322 4.322 0 0 0-.211-.434c-.349-.626-.92-1.36-1.627-2.067-.707-.707-1.441-1.279-2.068-1.627-.31-.172-.62-.304-.903-.36-.262-.05-.64-.058-.918.219l-.217.216zM4.16 1.867c.381.356.844.922 1.311 1.632l-.704.705c-.382-.727-.66-1.402-.813-1.938a3.283 3.283 0 0 1-.131-.673c.091.061.204.15.337.274zm.394 3.965c.54.852 1.107 1.567 1.607 2.033a.5.5 0 1 0 .682-.732c-.453-.422-1.017-1.136-1.564-2.027l1.088-1.088c.054.12.115.243.183.365.349.627.92 1.361 1.627 2.068.706.707 1.44 1.278 2.068 1.626.122.068.244.13.365.183l-4.861 4.862a.571.571 0 0 1-.068-.01c-.137-.027-.342-.104-.608-.252-.524-.292-1.186-.8-1.846-1.46-.66-.66-1.168-1.32-1.46-1.846-.147-.265-.225-.47-.251-.607a.573.573 0 0 1-.01-.068l3.048-3.047zm2.87-1.935a2.44 2.44 0 0 1-.241-.561c.135.033.324.11.562.241.524.292 1.186.8 1.846 1.46.45.45.83.901 1.118 1.31a3.497 3.497 0 0 0-1.066.091 11.27 11.27 0 0 1-.76-.694c-.66-.66-1.167-1.322-1.458-1.847z"/>
                ...
                <p style={{fontSize:"13px",borderRight: '1px solid #ccc',paddingRight:"0.5rem"}}>Black</p>
              </div>
              <div className='d-flex' style={{marginLeft:"0.5rem"}}>
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-paint-bucket mt-1" viewBox="0 0 16 16">
  <path d="M6.192 2.78c-.458-.677-.927-1.248-1.35-1.643a2.972 2.972 0 0 0-.71-.515c-.217-.104-.56-.205-.882-.02-.367.213-.427.63-.43.896-.003.304.064.664.173 1.044.196.687.556 1.528 1.035 2.402L.752 8.22c-.277.277-.269.656-.218.918.055.283.187.593.36.903.348.627.92 1.361 1.626 2.068.707.707 1.441 1.278 2.068 1.626.31.173.62.305.903.36.262.05.64.059.918-.218l5.615-5.615c.118.257.092.512.05.939-.03.292-.068.665-.073 1.176v.123h.003a1 1 0 0 0 1.993 0H14v-.057a1.01 1.01 0 0 0-.004-.117c-.055-1.25-.7-2.738-1.86-3.494a4.322 4.322 0 0 0-.211-.434c-.349-.626-.92-1.36-1.627-2.067-.707-.707-1.441-1.279-2.068-1.627-.31-.172-.62-.304-.903-.36-.262-.05-.64-.058-.918.219l-.217.216zM4.16 1.867c.381.356.844.922 1.311 1.632l-.704.705c-.382-.727-.66-1.402-.813-1.938a3.283 3.283 0 0 1-.131-.673c.091.061.204.15.337.274zm.394 3.965c.54.852 1.107 1.567 1.607 2.033a.5.5 0 1 0 .682-.732c-.453-.422-1.017-1.136-1.564-2.027l1.088-1.088c.054.12.115.243.183.365.349.627.92 1.361 1.627 2.068.706.707 1.44 1.278 2.068 1.626.122.068.244.13.365.183l-4.861 4.862a.571.571 0 0 1-.068-.01c-.137-.027-.342-.104-.608-.252-.524-.292-1.186-.8-1.846-1.46-.66-.66-1.168-1.32-1.46-1.846-.147-.265-.225-.47-.251-.607a.573.573 0 0 1-.01-.068l3.048-3.047zm2.87-1.935a2.44 2.44 0 0 1-.241-.561c.135.033.324.11.562.241.524.292 1.186.8 1.846 1.46.45.45.83.901 1.118 1.31a3.497 3.497 0 0 0-1.066.091 11.27 11.27 0 0 1-.76-.694c-.66-.66-1.167-1.322-1.458-1.847z"/>
</svg>
                <p style={{fontSize:"13px", marginRight:"1rem"}}>2XL</p>

              </div>
            </div>
            <div class="input-group mt-3 mb-0">
              <button class="btn btn-outline-secondary" type="button" style={{borderRadius:"50%",height:"20px", width:"20px", textAlign:"center", padding:"0"}}><span style={{ lineHeight: "0" }}>-</span></button>
              <p style={{marginRight:"1rem",marginLeft:"1rem"}}>1</p>
              <button class="btn btn-outline-secondary btn-circle" type="button" style={{borderRadius:"50%",height:"1.25rem",width:"1.25rem", textAlign:"center", padding:"0",margin:"0"}}>+</button>
            </div>
          </div>
          <div class="col-md-3 position-relative">
            <p class="position-absolute top-0 end-0" style={{borderColor:"green"}}>$74</p>
        ...
        <div class="row border-bottom pb-3 mb-3">
          ...
          <div class="col-md-3 position-relative">
            <p class="position-absolute top-0 end-0">$132</p>
            <p class="position-absolute bottom-0 end-0 " style={{color:"#005792"}}>Remove</p>
          </div>
        </div>
        <div class="row border-bottom pb-3 mb-3">
        <div class="col-md-3 card d-flex align-items-center justify-content-center bg-light border-0">
          ...
          <div class="col-md-3 position-relative">
            <p class="position-absolute top-0 end-0">$28</p>
            <p class="position-absolute bottom-0 end-0 " style={{color:"#005792"}}>Remove</p>
          </div>
        </div>
        <div class="container m-0 p-0">
          ...
          <div className='d-flex'>
            ...
            <div>
              <button class="btn btn-secondary" type="button" id="apply-button" style={{borderRadius:"1.2rem", paddingLeft:"1rem",paddingRight:"1rem"}}>Apply</button>
            </div>
          </div>
        </div>
    ...
    <div class="row mt-1">
      <div class="col-md-12 text-center" style={{fontSize:"10px"}}>
        <i class="bi bi-info-circle"></i> Learn more <u>Taxes</u> and <u>Shipping</u> information
      </div>
    </div>
  </div>
      </div>
    ...
    <div class="container mt-5">
      ...
      <div class="row">
        <div class="col-md-3">
        <img src={logo1} alt="logo1" height="25rem" />
